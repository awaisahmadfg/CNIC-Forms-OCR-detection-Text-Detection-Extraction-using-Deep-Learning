...
# %%
# 9
image_path = r"C:\Users\hp\Desktop\Meter1.jpg"
...
bbs = []
values = []
# image = cv2.imread(r'C:\Users\hp\Desktop\CNIC.jpg')
image = cv2.imread(r'C:\Users\hp\Desktop\Meter1.jpg')
h,w,c = image.shape
...
# imgShow = cv2.resize(image, (w // 6, h // 6))
